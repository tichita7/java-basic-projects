...
public class StudentRecordOutputs {
	DataOutputStream dataOutput;
	
	public StudentRecordOutputs(String outputFile) throws IOException {
...
//		String outputfile = args[0];
		...
		try {
			StudentRecordOutputs outputWriter = new StudentRecordOutputs(outputFile);
